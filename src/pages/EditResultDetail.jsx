    ...
    useEffect(() => {
        const fetchResults = async () => {
            try {
                ...
                if (response?.documents) dispatch(setResults(response.documents));
            } catch (error) {
                                                        ...
                                                        <div className="left-digits flex flex-col items-center">
                                                            {data.days[day].map((entry, index) => (
                                                                <div key={`left-${week}-${day}-${index}`}>
                                                                    {results.map(result => (
                                                                        <div key={result.id}>
                                                                            {[result.firstD, result.secondD, result.thirdD]
                                                                                .map(d => d || "*")
                                                                                .join('')}
                                                                        </div>
                                                                    ))}
...
export default EditResultDetail;
